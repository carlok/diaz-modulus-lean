...
/-! ## The candidate is transcendental

This is the contrapositive of Hermite–Lindemann: if `u ≠ 0` and `exp u` is algebraic, then
`u` cannot be algebraic, for otherwise `exp u` would be transcendental. -/
