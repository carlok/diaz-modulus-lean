/-
Mirrored from Prove2Me: `DiazModulus.recip_pi_not_log_of_sfe`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.recip_pi_not_log_of_sfe__350525c2.lean`. Statement and proof are the platform's; only
...
theorem recip_pi_not_log_of_sfe :
  ...
  fun hS => XX1_recip_pi_not_log_of_sfe_hl hS hermite_lindemann_holds
