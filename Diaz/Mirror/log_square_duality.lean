/-
Mirrored from Prove2Me: `DiazModulus.log_square_duality`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.log_square_duality__0c62b199.lean`. Statement and proof are the platform's; only
...
theorem log_square_duality (l m : ℂ) (hl : IsAlgebraic ℚ (Complex.exp l))
  ...
  have hztr : Transcendental ℚ z := by
    intro hzalg
    have := GelfondSchneider.gelfond_schneider z m hzalg hzq hm hm0
    rw [hzm] at this
    exact this hl
