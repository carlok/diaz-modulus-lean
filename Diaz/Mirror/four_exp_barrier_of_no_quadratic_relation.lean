/-
Mirrored from Prove2Me: `DiazModulus.four_exp_barrier_of_no_quadratic_relation`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.four_exp_barrier_of_no_quadratic_relation__32650aad.lean`. Statement and proof are the platform's; only
...
theorem four_exp_barrier_of_no_quadratic_relation {n : ℕ} (e : Fin n → ℂ)
  ...
  rcases det_zero_linear_forms_rank_one n A
