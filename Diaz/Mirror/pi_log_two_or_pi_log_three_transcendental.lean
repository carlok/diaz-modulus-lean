/-
Mirrored from Prove2Me: `DiazModulus.pi_log_two_or_pi_log_three_transcendental`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.pi_log_two_or_pi_log_three_transcendental__3041b359.lean`. Statement and proof are the platform's; only
...
/-- `log 2 / log 3` is not rational: `2^d = 3^n` has no pi_log_two_or_pi_log_three_transcendental with `d ≥ 1`. -/
...
theorem pi_log_two_or_pi_log_three_transcendental :
  ...
  have hGS := GelfondSchneider.gelfond_schneider _ _ hb pilog_ratio_not_rat hl hl0
