/-
Mirrored from Prove2Me: `e_pi_transcendence`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/e_pi_transcendence__fd9af761.lean`. Statement and proof are the platform's; only
...
theorem e_pi_transcendence :
  ...
  have h := GelfondSchneider.gelfond_schneider (-Complex.I) (((Real.pi : ℝ) : ℂ) * Complex.I)
