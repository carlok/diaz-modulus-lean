/-
Mirrored from Prove2Me: `DiazModulus.generic_conj_pair_no_quadratic_relation`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.generic_conj_pair_no_quadratic_relation__74406b6d.lean`. Statement and proof are the platform's; only
...
noncomputable def P (a00 a02 a22 a01 a12 a11 : ↥Qbar) :
    MvPolynomial (Fin 2) ↥Qbar :=
  C a00 * X 0 ^ 4 + C a02 * X 0 ^ 3 * X 1 + C a22 * X 0 ^ 2 * X 1 ^ 2 + C a01 * X 0 ^ 2
    + C a12 * X 0 * X 1 + C a11

theorem aeval_P (a00 a02 a22 a01 a12 a11 : ↥Qbar) (a b : ℂ) :
...
theorem generic_conj_pair_no_quadratic_relation (u : ℂ) (hu : u ≠ 0)
  ...
  let Pu : MvPolynomial (Fin 2) ↥Qbar :=
    P (s00 : ↥Qbar) (s02 : ↥Qbar) (s22 : ↥Qbar)
      ((s01 : ↥Qbar) * r) ((s12 : ↥Qbar) * r)
      ((s11 : ↥Qbar) * r ^ 2)
