/-
Mirrored from Prove2Me: `DiazModulus.recip_pi_exp_value_not_root_of_unity`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.recip_pi_exp_value_not_root_of_unity__3f32a319.lean`. Statement and proof are the platform's; only
...
theorem recip_pi_exp_value_not_root_of_unity :
  ...
  fun γ hγ hne =>
    XX_recip_pi_exp_value_not_root_of_unity γ hγ hne
      pi_sq_transcendental
