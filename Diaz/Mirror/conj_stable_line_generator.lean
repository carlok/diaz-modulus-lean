/-
Mirrored from Prove2Me: `Diaz.conj_stable_line_generator`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.conj_stable_line_generator__191d4008.lean`. Statement and proof are the platform's; only
...
theorem conj_stable_line_generator {y : ℂ} (hy : ∀ q : ℚ, y ≠ (q : ℂ)) {a b : ℚ}
    (h : conj y = (a : ℂ) + (b : ℂ) * y) :
    (b = 1 ∧ a = 0 ∧ conj y = y)
