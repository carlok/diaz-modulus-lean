/-
Mirrored from Prove2Me: `DiazModulus.no_algebraic_generalized_line`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.no_algebraic_generalized_line__4e2d5085.lean`. Statement and proof are the platform's; only
...
def no_algebraic_generalized_line_BakerTwoLogs : Prop :=
  ∀ x y a b : ℂ,
...
theorem no_algebraic_generalized_line_indep_of_off_axes {l : ℂ} (hre : l.re ≠ 0) (him : l.im ≠ 0) :
...
theorem no_algebraic_generalized_line_no_algebraic_line (hB : no_algebraic_generalized_line_BakerTwoLogs)
  ...
  have htr : Transcendental ℚ (B * l + conj B * conj l) :=
    hB l (conj l) B (conj B) hlog hlogc (no_algebraic_generalized_line_indep_of_off_axes hre him) hBalg hBcalg
      (fun h => hB0 h.1)
...
theorem no_algebraic_generalized_line :
  ...
  fun hB l hlog hre him B C hBalg hB0 hCalg =>
    DiazLine.no_algebraic_generalized_line_no_algebraic_line hB hlog hre him hBalg hB0 hCalg
