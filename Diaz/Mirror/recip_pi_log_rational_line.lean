/-
Mirrored from Prove2Me: `DiazModulus.recip_pi_log_rational_line`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.recip_pi_log_rational_line__6655a686.lean`. Statement and proof are the platform's; only
...
theorem recip_pi_log_rational_line :
  ...
  have hGS := GelfondSchneider.gelfond_schneider (γ₁ / γ₂) (γ₂ / (((Real.pi : ℝ) : ℂ) * Complex.I))
    hb hbq he2 hl0
