/-
Mirrored from Prove2Me: `Diaz.rank_one_of_det_eq_zero`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.rank_one_of_det_eq_zero__905c582b.lean`. Statement and proof are the platform's; only
...
theorem rank_one_of_det_eq_zero {F : Type*} [Field F] (M : Matrix (Fin 2) (Fin 2) F)
    (hM : M.det = 0) :
