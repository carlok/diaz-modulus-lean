/-
Mirrored from Prove2Me: `DiazModulus.exp_abs_transcendental_of_isAlgebraic_adjoin`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.exp_abs_transcendental_of_isAlgebraic_adjoin__5439b4c3.lean`. Statement and proof are the platform's; only
...
theorem exp_abs_transcendental_of_isAlgebraic_adjoin_exp_conj_alg {w : ℂ} (hw : IsAlgebraic ℚ (Complex.exp w)) :
...
theorem exp_abs_transcendental_of_isAlgebraic_adjoin (lam x : ℂ)
  ...
  rcases four_exponentials_trdeg_one _ _ _ _ hr (exp_abs_transcendental_of_isAlgebraic_adjoin_exp_conj_alg hlam) hlam hr
