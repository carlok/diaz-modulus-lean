/-
Mirrored from Prove2Me: `GelfondSchneider.main_estimate`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/GelfondSchneider.main_estimate__44a1b4ed.lean`. Statement and proof are the platform's; only
