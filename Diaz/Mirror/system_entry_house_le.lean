/-
Mirrored from Prove2Me: `GelfondSchneider.system_entry_house_le`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/GelfondSchneider.system_entry_house_le__28141bf1.lean`. Statement and proof are the platform's; only
