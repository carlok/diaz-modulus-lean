/-
Mirrored from Prove2Me: `DiazModulus.diaz_of_schanuel`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.diaz_of_schanuel__9f52c1d5.lean`. Statement and proof are the platform's; only
...
theorem diaz_of_schanuel (hS : SchanuelConjecture) : DiazModulusConjecture := by
