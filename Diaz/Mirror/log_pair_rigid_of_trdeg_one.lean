/-
Mirrored from Prove2Me: `DiazModulus.log_pair_rigid_of_trdeg_one`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.log_pair_rigid_of_trdeg_one__29db2aa6.lean`. Statement and proof are the platform's; only
...
theorem log_pair_rigid_of_trdeg_one (u v : ℂ) (hu : u ≠ 0) (hv : v ≠ 0)
  ...
  rcases four_exponentials_trdeg_one u v ((c : ℂ) * conj v) (conj u)
