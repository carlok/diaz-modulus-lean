/-
Mirrored from Prove2Me: `Diaz.quadric_trdeg_two`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.quadric_trdeg_two__f3bad266.lean`. Statement and proof are the platform's; only
...
theorem quadric_trdeg_two {K : Subfield ℂ}
