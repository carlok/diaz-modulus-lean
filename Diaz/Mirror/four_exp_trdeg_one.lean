/-
Mirrored from Prove2Me: `Diaz.four_exp_trdeg_one`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.four_exp_trdeg_one__9add7c18.lean`. Statement and proof are the platform's; only
...
theorem four_exp_trdeg_one {K : Subfield ℂ}
    (hMaster : ∀ μ₁ ν₁ μ₂ ν₂ : ℂ,
