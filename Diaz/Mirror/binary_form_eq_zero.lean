/-
Mirrored from Prove2Me: `Diaz.binary_form_eq_zero`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.binary_form_eq_zero__9cd387c4.lean`. Statement and proof are the platform's; only
...
theorem binary_form_eq_zero_aux_powers_indep {K : Subfield ℂ} {u : ℂ} (hT : Transcendental K u) (n : ℕ)
    (k : ℕ → ℂ) (hk : ∀ i, k i ∈ K)
...
theorem binary_form_eq_zero {K : Subfield ℂ} {x y : ℂ} (hy : y ≠ 0)
  ...
  refine binary_form_eq_zero_aux_powers_indep hxy (d + 1) c hc ?_
