/-
Mirrored from Prove2Me: `Diaz.padic_conjugate_planes`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.padic_conjugate_planes__ce4d5028.lean`. Statement and proof are the platform's; only
...
theorem padic_conjugate_planes {F : Type*} [Field F] (A : Subfield F) (V : Set F)
    (hVadd : ∀ y ∈ V, ∀ z ∈ V, y + z ∈ V)
    (hVmul : ∀ c ∈ A, ∀ y ∈ V, c * y ∈ V)
    (hone : (1 : F) ∈ V)
