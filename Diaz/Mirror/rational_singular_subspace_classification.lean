/-
Mirrored from Prove2Me: `Diaz.rational_singular_subspace_classification`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.rational_singular_subspace_classification__b04197c2.lean`. Statement and proof are the platform's; only
...
theorem rational_singular_subspace_classification
