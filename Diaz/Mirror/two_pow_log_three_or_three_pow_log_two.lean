/-
Mirrored from Prove2Me: `DiazModulus.two_pow_log_three_or_three_pow_log_two`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.two_pow_log_three_or_three_pow_log_two__658994ad.lean`. Statement and proof are the platform's; only
...
/-- `log 2 / log 3` is not rational: `2^d = 3^n` has no two_pow_log_three_or_three_pow_log_two with `d ≥ 1`. -/
...
theorem two_pow_log_three_or_three_pow_log_two_alg_exp_log (p : ℕ) (hp : 0 < p) :
...
theorem two_pow_log_three_or_three_pow_log_two :
  ...
  have hind : LinearIndependent ℚ ![((Real.log 2 : ℝ) : ℂ), ((Real.log 3 : ℝ) : ℂ)] := by
    ...
    · exfalso
      ...
      field_simp
      linarith
  have hl := two_pow_log_three_or_three_pow_log_two_alg_exp_log 2 (by norm_num)
  have hm := two_pow_log_three_or_three_pow_log_two_alg_exp_log 3 (by norm_num)
  push_cast at hl hm
  rcases log_square_duality _ _ hl hm hind with h | h
