/-
Mirrored from Prove2Me: `GelfondSchneider.deriv_identity`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/GelfondSchneider.deriv_identity__37558649.lean`. Statement and proof are the platform's; only
