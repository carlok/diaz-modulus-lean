...
`archive/prove2me/FourExp.extrapolation__60352656.lean`. Statement and proof are the platform's; only
...
lemma zeros_bound (F : ℂ → ℂ) (hF : Differentiable ℂ F) (w : ℂ) (ρ R M : ℝ) (hρ : 0 ≤ ρ)
  ...
  have hC := cauchy_estimate_with_zeros F hF w ρ R M hρ hR P hP hM s
