/-
Mirrored from Prove2Me: `Diaz.balanced_jet_mem_iff`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.balanced_jet_mem_iff__22a15979.lean`. Statement and proof are the platform's; only
...
theorem balanced_jet_mem_iff {K : Subfield ℂ} {u : ℂ} (hT : Transcendental K u) (hu0 : u ≠ 0)
