/-
Mirrored from Prove2Me: `DiazModulus.generic_indistinguishable_over_pi`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.generic_indistinguishable_over_pi__5f024a50.lean`. Statement and proof are the platform's; only
...
theorem generic_indistinguishable_over_pi (K : Subfield ℂ)
  ...
  obtain ⟨t, htc, htr, hexp⟩ :=
    exists_noncandidate_transcendental_on_circle K hKcount hpos
  ...
  exact ⟨t, ht0, htr, hut, hexp,
    circle_points_indistinguishable K hKc hρK hgen htr hut⟩
