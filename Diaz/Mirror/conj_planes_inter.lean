/-
Mirrored from Prove2Me: `Diaz.conj_planes_inter`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.conj_planes_inter__32f573ae.lean`. Statement and proof are the platform's; only
...
theorem conj_planes_inter {K : Subfield ℂ} {u : ℂ} (hT : Transcendental (↥K) u) (hρ : u * conj u ∈ K)
