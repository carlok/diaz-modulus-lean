/-
Mirrored from Prove2Me: `DiazModulus.det_linear_forms_isotropic`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/DiazModulus.det_linear_forms_isotropic__9b782056.lean`. Statement and proof are the platform's; only
