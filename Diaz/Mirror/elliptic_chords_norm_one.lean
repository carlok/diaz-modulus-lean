/-
Mirrored from Prove2Me: `Diaz.elliptic_chords_norm_one`.

Ported mechanically from the accepted submission archived as
`archive/prove2me/Diaz.elliptic_chords_norm_one__eb6bdba8.lean`. Statement and proof are the platform's; only
...
theorem elliptic_chords_norm_one {k : Subfield ℂ} (hkc : ∀ x ∈ k, conj x ∈ k)
