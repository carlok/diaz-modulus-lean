...
transcendental. No linear forms in logarithms are needed. This statement has no machine-checked
counterpart; Theorem~\ref{thm:line}, which is stronger in dropping the hypothesis on $|u|$, does.
\end{remark}
...
says: the statement is proved in this note and has no formal counterpart at all. There are three,
...
Rem.~\ref{rem:line-cheap} & Not formalised & --- \\
