...
\date{September 2026\\[2pt]\small Version 1.3, 24 September 2026}
...
transcendental. What does detect a counterexample needs a constant term. The configurations of
Theorems~\ref{thm:sfe-implies-diaz} and~\ref{thm:S-of-sfe} have one. In the generic case, one can
show that the period $i\pi$ never enters a configuration that detects a candidate (this is not
formalised). Non-generic candidates can carry homogeneous relations. For example
$\operatorname{Re}(u^{2})=\pi^{2}$ is satisfied by points of every circle of algebraic radius
$r>\pi$. But such a relation is never the determinant of a $2\times2$ matrix over the certified
logarithms unless the four exponentials theorem in transcendence degree one already excludes it.
...
This is version 1.3 of the note; version 1.0 of 21 September 2026 is the first stable release.
Every row of the table below was checked against the platform by script on 24 September 2026, and
the mirrored project held all 200 proved results of the development at that date.
