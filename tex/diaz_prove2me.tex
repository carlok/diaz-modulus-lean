...
it governs is proved with it. What is left is open mathematics rather than formalisation, and we say
exactly which.
\end{abstract}
...
row means the statement is recorded formally but not proved; both such rows here are open
conjectures. A \textbf{Not formalised} row means what it says: the statement is proved in this note and has no formal counterpart at all.
