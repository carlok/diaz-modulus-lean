...
\date{September 2026\\[2pt]\small Version 1.4, 24 September 2026}
...
candidate supplies for free, is of no use to it.

Non-generic candidates can carry homogeneous relations, and these can be listed.
...
A relation with a non-trivial rational zero can be a determinant; the configuration it gives lies
in transcendence degree one, where Proposition~\ref{prop:homog-nongeneric} excludes it. A relation
without one, like $\operatorname{Re}(u^{2})=\pi^{2}$, is excluded by nothing this note knows of,
but it never produces a configuration at all, and (b) does not use $\e^{u}$.
...
This is version 1.4 of the note; version 1.0 of 21 September 2026 is the first stable release.
Every row of the table below was checked against the platform by script on 24 September 2026, and
the mirrored project held all 210 proved results of the development at that date.
